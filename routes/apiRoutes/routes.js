...
// Reads the database file and return all the saved notes as JSON
...
// Post request receives new note to save, add it to the database file, and return the new note to the client
